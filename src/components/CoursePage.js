  ...
  return (
    <div className="container">
      ...
      <div className="CoursePage row course-icon">
      	<div className="col">
      		<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRw728JESaDNMSj_h3zrUUD49Xwgf0WNGAQcZKn7Kk9aZm2fGMK&usqp=CAU" className="img-thumbnail float-left" alt="Cinque Terre" style={{'width':'20vw'}}/>
      		{/* <img src={imgURL} className="img-thumbnail float-left" alt="Cinque Terre" style={{'width':'20vw','marginBottom':'10px'}}/> */}
		<div className="CoursePage row course-introduction" style={{}}>
			<div className="col">
		    	<p className="CoursePage text-justify" style={{'fontSize':'16pt'}}>{intro}</p>
			</div>
      	</div>
	  <div className="CoursePage row" style={{}}>
	  	<GetSkills node={node} level={level} />
	  </div>
      <div className="CoursePage row course-link" style={{'marginTop':'7px'}}>
		<div className="col">
